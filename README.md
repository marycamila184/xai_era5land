...
**Authors:** Osmary Camila Bortoncello Glober, Vitor Gabriel Pignatari Israel Matias, Anderson Ara
...
```bash
python scripts/processing/daily_aggregation.py                 # everything
python scripts/processing/daily_aggregation.py --groups tp temp # a subset
python scripts/processing/daily_aggregation.py --start-year 2000 --end-year 2010
```
